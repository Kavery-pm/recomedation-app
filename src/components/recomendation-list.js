...
const RecomendationList = () => {
  ...
  useEffect(() => {
    setLoading(true);
    fetch(
      "htps://gist.githubusercontent.com/diegoacuna/0c7d5508a3af22dd1922eb98156bb402/raw/f5e87043c1e676354c9c723b0bfd23d2094a6be1/react_fullstack_recommendations_2.json"
    )
      .then((response) => {
